        ...
        <div className='container bg-light p-3 main' id='main-pie'>
            ...
            <div className='row'>
                ...
                <span>
                    ...
                    <button type="button" className="btn" data-bs-toggle="modal" data-bs-target="#modalPieInfo">
                        <i class="fa-solid fa-circle-info"></i>
                    </button>

                    <div className="modal fade" id="modalPieInfo" tabIndex="-1" aria-labelledby="modalPieInfoLabel" aria-hidden="true">
                        <div className="modal-dialog">
                            <div className="modal-content">
                                <div className="modal-header">
